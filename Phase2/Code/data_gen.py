...
def main():
    ...
    parser.add_argument("--output_dir", default="Phase2/Data/TrajectoriesCirclesHeight")
    ...
    for i, path in enumerate(sampled_paths):
        ...
        trajectory, imu_data, gt_data = generator.generate_random_trajectory(trajectory_type="circle_changing_height", duration=10, frequency=1000)
